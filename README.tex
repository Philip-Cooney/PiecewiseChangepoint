...
\href{https://github.com/Philip-Cooney/PiecewiseChangepoint}{GitHub}
with:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{devtools}\SpecialCharTok{::}\FunctionTok{install\_github}\NormalTok{(}\StringTok{"Philip{-}Cooney/PiecewiseChangepoint"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
