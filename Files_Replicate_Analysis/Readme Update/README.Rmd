...
```{r, include = FALSE}
library("survminer", lib.loc = "~/R-packages/")
library("survival")
library("xlsx")
library("dplyr")
library("flexsurv")
...
```{r fig.cap = 'Overview of all TAs investigated', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE,warning=FALSE}
